              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  children: [
                    ...
                    // Social login buttons — circular icon-only
                    Row(
...
class _GoogleLogoPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    // Re-draw colored segments
    _drawArcSegment(canvas, cx, cy, r * 0.72, size.width * 0.17,
        -0.52, 1.05, const Color(0xFF4285F4)); // blue top
    _drawArcSegment(canvas, cx, cy, r * 0.72, size.width * 0.17,
        0.53, 1.05, const Color(0xFF34A853)); // green bottom-right
    _drawArcSegment(canvas, cx, cy, r * 0.72, size.width * 0.17,
        1.58, 1.08, const Color(0xFFFBBC05)); // yellow bottom-left
    _drawArcSegment(canvas, cx, cy, r * 0.72, size.width * 0.17,
        2.66, 1.08, const Color(0xFFEA4335)); // red left
